...
This setup captures real-world OTLP profiling data to measure the impact of [reference-based attributes](https://github.com/open-telemetry/opentelemetry-proto/pull/733) on in-memory and wire size.
